			...
			<div class="col-xs-12 col-md-8">
				<div class="row-content">
					<div class="container-pla">
						<h1 class="<?php echo !is_front_page() ? __('b-title') : __('shop-title r-title') ?>">Wpisy</h1>
					</div>
					<?php if (have_posts()): ?>
						...
						<div class="row agd-post-excerpt" id="post-<?php get_the_ID(); ?>" <?php post_class(); ?>>
							<div class="products">
								...
								<div class="thumbnail-agd">
                                    ...
                                    <a href="<?php the_permalink(); ?>"><img width="" height="" src="<?php echo esc_url($image[0]); ?>"></a>
								</div>
								<?php printExcerpt(150);//the_excerpt(__('Czytaj dalej »', 'boma_agd')); ?>
								<?php echo moreText(); ?>
							</div>
							</div><?php get_the_ID(); ?>
						<?php endwhile; ?>
